...
echo "✓ Terminal inline image display (show actual image, not ASCII)"
echo "✓ Multi-protocol support (Kitty, iTerm2, Sixel) - 12+ terminals"
echo "✓ Smart auto-detection with graceful fallback"
...
echo "  Inline image:     ./tiv -p image.jpg"
echo "  System preview:   ./tiv -p -preview-mode system image.jpg"
